...
def preprocess_elexon_data(input_path='../dataset/elexon_dataset.csv', output_path='../backend/app/data/processed_elexon_data.csv'):
...
if __name__ == "__main__":
    ...
    input_path = os.path.join(current_dir, '../dataset/elexon_dataset.csv')
